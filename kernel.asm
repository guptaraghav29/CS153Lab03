...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 a3 77 10 80 	movl   $0x801077a3,(%esp)
...
80100b67:	0f 84 93 00 00 00    	je     80100c00 <exec+0x260>
  curproc->stackGrow = 1;
80100b6d:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
80100b73:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
  for(argc = 0; argv[argc]; argc++) {
80100b79:	8b 45 0c             	mov    0xc(%ebp),%eax
80100b7c:	8b 00                	mov    (%eax),%eax
80100b7e:	85 c0                	test   %eax,%eax
80100b80:	0f 84 8f 01 00 00    	je     80100d15 <exec+0x375>
80100b86:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80100b89:	31 d2                	xor    %edx,%edx
80100b8b:	8d 71 04             	lea    0x4(%ecx),%esi
80100b8e:	89 cf                	mov    %ecx,%edi
80100b90:	89 d1                	mov    %edx,%ecx
80100b92:	89 f2                	mov    %esi,%edx
80100b94:	89 ce                	mov    %ecx,%esi
80100b96:	eb 26                	jmp    80100bbe <exec+0x21e>
...
80100bf7:	e8 94 60 00 00       	call   80106c90 <copyout>
...
80100c09:	e8 a2 5d 00 00       	call   801069b0 <freevm>
  return -1;
...
80100c18:	e8 53 1f 00 00       	call   80102b70 <end_op>
    cprintf("exec: fail\n");
80100c1d:	c7 04 24 21 6e 10 80 	movl   $0x80106e21,(%esp)
...
80100c75:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c7b:	e8 10 60 00 00       	call   80106c90 <copyout>
...
80100ccd:	8b 85 ec fe ff ff    	mov    -0x114(%ebp),%eax
  curproc->pgdir = pgdir;
80100cd3:	8b 95 f0 fe ff ff    	mov    -0x110(%ebp),%edx
  oldpgdir = curproc->pgdir;
80100cd9:	8b 77 08             	mov    0x8(%edi),%esi
  sz = PGROUNDUP(sz);
80100cdc:	05 ff 0f 00 00       	add    $0xfff,%eax
80100ce1:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80100ce6:	89 47 04             	mov    %eax,0x4(%edi)
  curproc->tf->eip = elf.entry;  // main
80100ce9:	8b 47 1c             	mov    0x1c(%edi),%eax
  curproc->pgdir = pgdir;
80100cec:	89 57 08             	mov    %edx,0x8(%edi)
  curproc->tf->eip = elf.entry;  // main
80100cef:	8b 95 3c ff ff ff    	mov    -0xc4(%ebp),%edx
80100cf5:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100cf8:	8b 47 1c             	mov    0x1c(%edi),%eax
80100cfb:	89 58 44             	mov    %ebx,0x44(%eax)
  switchuvm(curproc);
80100cfe:	89 3c 24             	mov    %edi,(%esp)
80100d01:	e8 0a 59 00 00       	call   80106610 <switchuvm>
  freevm(oldpgdir);
80100d06:	89 34 24             	mov    %esi,(%esp)
80100d09:	e8 a2 5c 00 00       	call   801069b0 <freevm>
  return 0;
80100d0e:	31 c0                	xor    %eax,%eax
80100d10:	e9 fd fc ff ff       	jmp    80100a12 <exec+0x72>
  for(argc = 0; argv[argc]; argc++) {
80100d15:	31 d2                	xor    %edx,%edx
80100d17:	8d 8d 58 ff ff ff    	lea    -0xa8(%ebp),%ecx
80100d1d:	e9 13 ff ff ff       	jmp    80100c35 <exec+0x295>
...
80102df6:	80 
80102df7:	c7 04 24 14 59 11 80 	movl   $0x80115914,(%esp)
...
801036dd:	0f 84 d5 00 00 00    	je     801037b8 <userinit+0xf8>
...
801036f6:	e8 25 30 00 00       	call   80106720 <inituvm>
  p->sz = PGSIZE;
801036fb:	c7 43 04 00 10 00 00 	movl   $0x1000,0x4(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
80103702:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
80103709:	00 
8010370a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80103711:	00 
80103712:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103715:	89 04 24             	mov    %eax,(%esp)
80103718:	e8 53 0b 00 00       	call   80104270 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
8010371d:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103720:	ba 1b 00 00 00       	mov    $0x1b,%edx
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103725:	b9 23 00 00 00       	mov    $0x23,%ecx
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
8010372a:	66 89 50 3c          	mov    %dx,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
8010372e:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103731:	66 89 48 2c          	mov    %cx,0x2c(%eax)
  p->tf->es = p->tf->ds;
80103735:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103738:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
8010373c:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80103740:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103743:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103747:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
8010374b:	8b 43 1c             	mov    0x1c(%ebx),%eax
8010374e:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80103755:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103758:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
8010375f:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103762:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103769:	8d 43 70             	lea    0x70(%ebx),%eax
8010376c:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80103773:	00 
80103774:	c7 44 24 04 25 73 10 	movl   $0x80107325,0x4(%esp)
8010377b:	80 
8010377c:	89 04 24             	mov    %eax,(%esp)
8010377f:	e8 cc 0c 00 00       	call   80104450 <safestrcpy>
  p->cwd = namei("/");
80103784:	c7 04 24 2e 73 10 80 	movl   $0x8010732e,(%esp)
8010378b:	e8 60 e7 ff ff       	call   80101ef0 <namei>
80103790:	89 43 6c             	mov    %eax,0x6c(%ebx)
  acquire(&ptable.lock);
80103793:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
8010379a:	e8 91 09 00 00       	call   80104130 <acquire>
  p->state = RUNNABLE;
8010379f:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  release(&ptable.lock);
801037a6:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801037ad:	e8 6e 0a 00 00       	call   80104220 <release>
}
801037b2:	83 c4 14             	add    $0x14,%esp
801037b5:	5b                   	pop    %ebx
801037b6:	5d                   	pop    %ebp
801037b7:	c3                   	ret    
    panic("userinit: out of memory?");
801037b8:	c7 04 24 0c 73 10 80 	movl   $0x8010730c,(%esp)
801037bf:	e8 9c cb ff ff       	call   80100360 <panic>
...
801037e3:	89 c3                	mov    %eax,%ebx
  sz = curproc->sz;
801037e5:	8b 40 04             	mov    0x4(%eax),%eax
  if(n > 0){
801037e8:	7e 2e                	jle    80103818 <growproc+0x48>
    if((sz = allocuvm(curproc->pgdir, sz, sz + n)) == 0)
801037ea:	01 c6                	add    %eax,%esi
801037ec:	89 74 24 08          	mov    %esi,0x8(%esp)
801037f0:	89 44 24 04          	mov    %eax,0x4(%esp)
801037f4:	8b 43 08             	mov    0x8(%ebx),%eax
801037f7:	89 04 24             	mov    %eax,(%esp)
801037fa:	e8 71 30 00 00       	call   80106870 <allocuvm>
801037ff:	85 c0                	test   %eax,%eax
80103801:	74 35                	je     80103838 <growproc+0x68>
  curproc->sz = sz;
80103803:	89 43 04             	mov    %eax,0x4(%ebx)
  switchuvm(curproc);
80103806:	89 1c 24             	mov    %ebx,(%esp)
80103809:	e8 02 2e 00 00       	call   80106610 <switchuvm>
  return 0;
...
80103818:	74 e9                	je     80103803 <growproc+0x33>
...
80103865:	89 44 24 04          	mov    %eax,0x4(%esp)
80103869:	8b 43 08             	mov    0x8(%ebx),%eax
8010386c:	89 04 24             	mov    %eax,(%esp)
8010386f:	e8 9c 32 00 00       	call   80106b10 <copyuvm>
80103874:	85 c0                	test   %eax,%eax
80103876:	89 47 08             	mov    %eax,0x8(%edi)
80103879:	0f 84 ae 00 00 00    	je     8010392d <fork+0xed>
  np->sz = curproc->sz;
8010387f:	8b 43 04             	mov    0x4(%ebx),%eax
80103882:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80103885:	89 41 04             	mov    %eax,0x4(%ecx)
  *np->tf = *curproc->tf;
80103888:	8b 79 1c             	mov    0x1c(%ecx),%edi
8010388b:	89 c8                	mov    %ecx,%eax
  np->parent = curproc;
8010388d:	89 59 18             	mov    %ebx,0x18(%ecx)
  *np->tf = *curproc->tf;
80103890:	8b 73 1c             	mov    0x1c(%ebx),%esi
80103893:	b9 13 00 00 00       	mov    $0x13,%ecx
80103898:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  np->tf->eax = 0;
8010389a:	89 c1                	mov    %eax,%ecx
  for(i = 0; i < NOFILE; i++)
8010389c:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
8010389e:	8b 40 1c             	mov    0x1c(%eax),%eax
801038a1:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  np->stackGrow = curproc->stackGrow;
801038a8:	8b 03                	mov    (%ebx),%eax
...
80103e74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e78:	c7 04 24 a3 77 10 80 	movl   $0x801077a3,(%esp)
...
80105303:	8b 55 f4             	mov    -0xc(%ebp),%edx
  addr = myproc()->sz;
80105306:	8b 58 04             	mov    0x4(%eax),%ebx
  if(growproc(n) < 0)
80105309:	89 14 24             	mov    %edx,(%esp)
8010530c:	e8 bf e4 ff ff       	call   801037d0 <growproc>
80105311:	85 c0                	test   %eax,%eax
80105313:	78 0b                	js     80105320 <sys_sbrk+0x40>
    return -1;
  return addr;
80105315:	89 d8                	mov    %ebx,%eax
}
80105317:	83 c4 24             	add    $0x24,%esp
8010531a:	5b                   	pop    %ebx
8010531b:	5d                   	pop    %ebp
8010531c:	c3                   	ret    
...
80105325:	eb f0                	jmp    80105317 <sys_sbrk+0x37>
...
80105512:	0f 84 f0 01 00 00    	je     80105708 <trap+0x208>
    if(myproc()->killed)
      exit();
    return;
  }
...
8010551e:	77 60                	ja     80105580 <trap+0x80>
80105520:	ff 24 85 24 76 10 80 	jmp    *-0x7fef89dc(,%eax,4)
80105527:	90                   	nop
...
8010552d:	a3 60 4d 11 80       	mov    %eax,0x80114d60
...
80105532:	0f 20 d2             	mov    %cr2,%edx
    pagefault = rcr2();

    if (pagefault > 0x7FFFFFFF)
80105535:	85 d2                	test   %edx,%edx
    pagefault = rcr2();
80105537:	89 15 c4 55 11 80    	mov    %edx,0x801155c4
    if (pagefault > 0x7FFFFFFF)
8010553d:	0f 88 3d 02 00 00    	js     80105780 <trap+0x280>
      exit();
    
    if (allocuvm(curproc->pgdir, PGROUNDDOWN(pagefault), pagefault) == 0) {
80105543:	89 54 24 08          	mov    %edx,0x8(%esp)
80105547:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
8010554d:	89 54 24 04          	mov    %edx,0x4(%esp)
80105551:	8b 40 08             	mov    0x8(%eax),%eax
80105554:	89 04 24             	mov    %eax,(%esp)
80105557:	e8 14 13 00 00       	call   80106870 <allocuvm>
8010555c:	85 c0                	test   %eax,%eax
8010555e:	75 20                	jne    80105580 <trap+0x80>
      cprintf("Page fault, Allocuvm failed, Current number of pages: %d\n", curproc->stackGrow);
80105560:	a1 60 4d 11 80       	mov    0x80114d60,%eax
80105565:	8b 00                	mov    (%eax),%eax
80105567:	c7 04 24 70 75 10 80 	movl   $0x80107570,(%esp)
8010556e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105572:	e8 d9 b0 ff ff       	call   80100650 <cprintf>
      exit();
80105577:	e8 14 e5 ff ff       	call   80103a90 <exit>
...
80105587:	0f 84 08 02 00 00    	je     80105795 <trap+0x295>
8010558d:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105591:	0f 84 fe 01 00 00    	je     80105795 <trap+0x295>
80105597:	0f 20 d1             	mov    %cr2,%ecx
...
8010559a:	8b 53 38             	mov    0x38(%ebx),%edx
8010559d:	89 4d d8             	mov    %ecx,-0x28(%ebp)
801055a0:	89 55 dc             	mov    %edx,-0x24(%ebp)
801055a3:	e8 c8 e0 ff ff       	call   80103670 <cpuid>
801055a8:	8b 73 30             	mov    0x30(%ebx),%esi
801055ab:	89 c7                	mov    %eax,%edi
801055ad:	8b 43 34             	mov    0x34(%ebx),%eax
801055b0:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
801055b3:	e8 d8 e0 ff ff       	call   80103690 <myproc>
801055b8:	89 45 e0             	mov    %eax,-0x20(%ebp)
801055bb:	e8 d0 e0 ff ff       	call   80103690 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801055c0:	8b 4d d8             	mov    -0x28(%ebp),%ecx
801055c3:	89 74 24 0c          	mov    %esi,0xc(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
801055c7:	8b 75 e0             	mov    -0x20(%ebp),%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801055ca:	8b 55 dc             	mov    -0x24(%ebp),%edx
801055cd:	89 7c 24 14          	mov    %edi,0x14(%esp)
801055d1:	8b 7d e4             	mov    -0x1c(%ebp),%edi
801055d4:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
801055d8:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801055db:	89 54 24 18          	mov    %edx,0x18(%esp)
801055df:	89 7c 24 10          	mov    %edi,0x10(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
801055e3:	89 74 24 08          	mov    %esi,0x8(%esp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801055e7:	8b 40 14             	mov    0x14(%eax),%eax
801055ea:	c7 04 24 e0 75 10 80 	movl   $0x801075e0,(%esp)
801055f1:	89 44 24 04          	mov    %eax,0x4(%esp)
801055f5:	e8 56 b0 ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801055fa:	e8 91 e0 ff ff       	call   80103690 <myproc>
801055ff:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
  }
...
80105606:	e8 85 e0 ff ff       	call   80103690 <myproc>
8010560b:	85 c0                	test   %eax,%eax
8010560d:	74 0c                	je     8010561b <trap+0x11b>
8010560f:	e8 7c e0 ff ff       	call   80103690 <myproc>
80105614:	8b 50 28             	mov    0x28(%eax),%edx
80105617:	85 d2                	test   %edx,%edx
80105619:	75 45                	jne    80105660 <trap+0x160>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
8010561b:	e8 70 e0 ff ff       	call   80103690 <myproc>
80105620:	85 c0                	test   %eax,%eax
80105622:	74 0b                	je     8010562f <trap+0x12f>
80105624:	e8 67 e0 ff ff       	call   80103690 <myproc>
80105629:	83 78 10 04          	cmpl   $0x4,0x10(%eax)
8010562d:	74 49                	je     80105678 <trap+0x178>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010562f:	e8 5c e0 ff ff       	call   80103690 <myproc>
80105634:	85 c0                	test   %eax,%eax
80105636:	74 1d                	je     80105655 <trap+0x155>
80105638:	e8 53 e0 ff ff       	call   80103690 <myproc>
8010563d:	8b 40 28             	mov    0x28(%eax),%eax
80105640:	85 c0                	test   %eax,%eax
80105642:	74 11                	je     80105655 <trap+0x155>
80105644:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105648:	83 e0 03             	and    $0x3,%eax
8010564b:	66 83 f8 03          	cmp    $0x3,%ax
8010564f:	0f 84 e4 00 00 00    	je     80105739 <trap+0x239>
    exit();
}
80105655:	83 c4 3c             	add    $0x3c,%esp
80105658:	5b                   	pop    %ebx
80105659:	5e                   	pop    %esi
8010565a:	5f                   	pop    %edi
8010565b:	5d                   	pop    %ebp
...
8010566b:	75 ae                	jne    8010561b <trap+0x11b>
    exit();
8010566d:	e8 1e e4 ff ff       	call   80103a90 <exit>
80105672:	eb a7                	jmp    8010561b <trap+0x11b>
...
80105680:	75 ad                	jne    8010562f <trap+0x12f>
    yield();
80105682:	e8 29 e5 ff ff       	call   80103bb0 <yield>
80105687:	eb a6                	jmp    8010562f <trap+0x12f>
...
80105697:	0f 84 b3 00 00 00    	je     80105750 <trap+0x250>
8010569d:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
801056a0:	e8 cb d0 ff ff       	call   80102770 <lapiceoi>
    break;
801056a5:	e9 5c ff ff ff       	jmp    80105606 <trap+0x106>
...
801056b5:	e8 b6 d0 ff ff       	call   80102770 <lapiceoi>
    break;
801056ba:	e9 47 ff ff ff       	jmp    80105606 <trap+0x106>
801056bf:	90                   	nop
    uartintr();
801056c0:	e8 2b 02 00 00       	call   801058f0 <uartintr>
    lapiceoi();
801056c5:	e8 a6 d0 ff ff       	call   80102770 <lapiceoi>
    break;
801056ca:	e9 37 ff ff ff       	jmp    80105606 <trap+0x106>
801056cf:	90                   	nop
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801056d0:	8b 7b 38             	mov    0x38(%ebx),%edi
801056d3:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
801056d7:	e8 94 df ff ff       	call   80103670 <cpuid>
801056dc:	c7 04 24 4c 75 10 80 	movl   $0x8010754c,(%esp)
...
801056f4:	e8 77 d0 ff ff       	call   80102770 <lapiceoi>
    break;
801056f9:	e9 08 ff ff ff       	jmp    80105606 <trap+0x106>
801056fe:	66 90                	xchg   %ax,%ax
    ideintr();
80105700:	e8 6b c9 ff ff       	call   80102070 <ideintr>
80105705:	eb 96                	jmp    8010569d <trap+0x19d>
80105707:	90                   	nop
80105708:	90                   	nop
...
8010574d:	eb cd                	jmp    8010571c <trap+0x21c>
8010574f:	90                   	nop
      acquire(&tickslock);
80105750:	c7 04 24 80 4d 11 80 	movl   $0x80114d80,(%esp)
80105757:	e8 d4 e9 ff ff       	call   80104130 <acquire>
      wakeup(&ticks);
8010575c:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
      ticks++;
80105763:	83 05 c0 55 11 80 01 	addl   $0x1,0x801155c0
      wakeup(&ticks);
8010576a:	e8 11 e6 ff ff       	call   80103d80 <wakeup>
      release(&tickslock);
8010576f:	c7 04 24 80 4d 11 80 	movl   $0x80114d80,(%esp)
80105776:	e8 a5 ea ff ff       	call   80104220 <release>
8010577b:	e9 1d ff ff ff       	jmp    8010569d <trap+0x19d>
      exit();
80105780:	e8 0b e3 ff ff       	call   80103a90 <exit>
80105785:	8b 15 c4 55 11 80    	mov    0x801155c4,%edx
8010578b:	a1 60 4d 11 80       	mov    0x80114d60,%eax
80105790:	e9 ae fd ff ff       	jmp    80105543 <trap+0x43>
80105795:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105798:	8b 73 38             	mov    0x38(%ebx),%esi
8010579b:	e8 d0 de ff ff       	call   80103670 <cpuid>
801057a0:	89 7c 24 10          	mov    %edi,0x10(%esp)
801057a4:	89 74 24 0c          	mov    %esi,0xc(%esp)
801057a8:	89 44 24 08          	mov    %eax,0x8(%esp)
801057ac:	8b 43 30             	mov    0x30(%ebx),%eax
801057af:	c7 04 24 ac 75 10 80 	movl   $0x801075ac,(%esp)
801057b6:	89 44 24 04          	mov    %eax,0x4(%esp)
801057ba:	e8 91 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
801057bf:	c7 04 24 46 75 10 80 	movl   $0x80107546,(%esp)
801057c6:	e8 95 ab ff ff       	call   80100360 <panic>
...
801058b7:	00 
  for(p="xv6...\n"; *p; p++)
801058b8:	bb ec 76 10 80       	mov    $0x801076ec,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010649a:	c3                   	ret    
        panic("kfree");
8010649b:	c7 04 24 06 70 10 80 	movl   $0x80107006,(%esp)
...
801065e1:	c3                   	ret    
      panic("remap");
801065e2:	c7 04 24 f4 76 10 80 	movl   $0x801076f4,(%esp)
801065e9:	e8 72 9d ff ff       	call   80100360 <panic>
801065ee:	66 90                	xchg   %ax,%ax

801065f0 <switchkvm>:
  lcr3(V2P(kpgdir));   // switch to the kernel page table
801065f0:	a1 c8 55 11 80       	mov    0x801155c8,%eax
{
...
801066f1:	c7 04 24 fa 76 10 80 	movl   $0x801076fa,(%esp)
801066f8:	e8 63 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
801066fd:	c7 04 24 25 77 10 80 	movl   $0x80107725,(%esp)
80106704:	e8 57 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106709:	c7 04 24 10 77 10 80 	movl   $0x80107710,(%esp)
...
8010679e:	c7 04 24 39 77 10 80 	movl   $0x80107739,(%esp)
...
80106852:	c7 04 24 53 77 10 80 	movl   $0x80107753,(%esp)
80106859:	e8 02 9b ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
8010685e:	c7 04 24 fc 77 10 80 	movl   $0x801077fc,(%esp)
...
80106879:	8b 7d 10             	mov    0x10(%ebp),%edi
  if(newsz > KERNBASE)
8010687c:	81 ff 00 00 00 80    	cmp    $0x80000000,%edi
80106882:	0f 87 98 00 00 00    	ja     80106920 <allocuvm+0xb0>
  if(newsz < oldsz)
80106888:	3b 7d 0c             	cmp    0xc(%ebp),%edi
    return oldsz;
8010688b:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
8010688e:	0f 82 8e 00 00 00    	jb     80106922 <allocuvm+0xb2>
  a = PGROUNDUP(oldsz);
80106894:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
8010689a:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
801068a0:	39 df                	cmp    %ebx,%edi
801068a2:	77 5b                	ja     801068ff <allocuvm+0x8f>
801068a4:	e9 87 00 00 00       	jmp    80106930 <allocuvm+0xc0>
...
801068c3:	e8 a8 d9 ff ff       	call   80104270 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
801068c8:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
801068ce:	89 44 24 0c          	mov    %eax,0xc(%esp)
801068d2:	8b 45 08             	mov    0x8(%ebp),%eax
801068d5:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801068dc:	00 
801068dd:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801068e4:	00 
801068e5:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801068e9:	89 04 24             	mov    %eax,(%esp)
801068ec:	e8 7f fc ff ff       	call   80106570 <mappages>
801068f1:	85 c0                	test   %eax,%eax
801068f3:	78 4b                	js     80106940 <allocuvm+0xd0>
  for(; a < newsz; a += PGSIZE){
801068f5:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801068fb:	39 df                	cmp    %ebx,%edi
801068fd:	76 31                	jbe    80106930 <allocuvm+0xc0>
    mem = kalloc();
801068ff:	e8 8c bb ff ff       	call   80102490 <kalloc>
    if(mem == 0){
80106904:	85 c0                	test   %eax,%eax
    mem = kalloc();
80106906:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106908:	75 a6                	jne    801068b0 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
8010690a:	c7 04 24 71 77 10 80 	movl   $0x80107771,(%esp)
80106911:	e8 3a 9d ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
80106916:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106919:	77 55                	ja     80106970 <allocuvm+0x100>
8010691b:	90                   	nop
8010691c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      return 0;
80106920:	31 c0                	xor    %eax,%eax
}
80106922:	83 c4 2c             	add    $0x2c,%esp
80106925:	5b                   	pop    %ebx
80106926:	5e                   	pop    %esi
80106927:	5f                   	pop    %edi
80106928:	5d                   	pop    %ebp
...
80106940:	c7 04 24 89 77 10 80 	movl   $0x80107789,(%esp)
80106947:	e8 04 9d ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
8010694c:	3b 7d 0c             	cmp    0xc(%ebp),%edi
8010694f:	76 0d                	jbe    8010695e <allocuvm+0xee>
80106951:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106954:	89 fa                	mov    %edi,%edx
80106956:	8b 45 08             	mov    0x8(%ebp),%eax
80106959:	e8 b2 fa ff ff       	call   80106410 <deallocuvm.part.0>
      kfree(mem);
8010695e:	89 34 24             	mov    %esi,(%esp)
80106961:	e8 7a b9 ff ff       	call   801022e0 <kfree>
}
80106966:	83 c4 2c             	add    $0x2c,%esp
      return 0;
80106969:	31 c0                	xor    %eax,%eax
}
8010696b:	5b                   	pop    %ebx
8010696c:	5e                   	pop    %esi
8010696d:	5f                   	pop    %edi
8010696e:	5d                   	pop    %ebp
8010696f:	c3                   	ret    
80106970:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106973:	89 fa                	mov    %edi,%edx
80106975:	8b 45 08             	mov    0x8(%ebp),%eax
80106978:	e8 93 fa ff ff       	call   80106410 <deallocuvm.part.0>
      return 0;
8010697d:	31 c0                	xor    %eax,%eax
8010697f:	eb a1                	jmp    80106922 <allocuvm+0xb2>
80106981:	eb 0d                	jmp    80106990 <deallocuvm>
80106983:	90                   	nop
80106984:	90                   	nop
80106985:	90                   	nop
80106986:	90                   	nop
...
801069a0:	5d                   	pop    %ebp
801069a1:	e9 6a fa ff ff       	jmp    80106410 <deallocuvm.part.0>
...
801069ca:	e8 41 fa ff ff       	call   80106410 <deallocuvm.part.0>
...
80106a13:	e9 c8 b8 ff ff       	jmp    801022e0 <kfree>
    panic("freevm: no pgdir");
80106a18:	c7 04 24 a5 77 10 80 	movl   $0x801077a5,(%esp)
...
80106a80:	e8 eb fa ff ff       	call   80106570 <mappages>
...
80106acb:	a3 c8 55 11 80       	mov    %eax,0x801155c8
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106aee:	e8 8d f8 ff ff       	call   80106380 <walkpgdir>
  if(pte == 0)
...
80106afb:	c3                   	ret    
    panic("clearpteu");
80106afc:	c7 04 24 b6 77 10 80 	movl   $0x801077b6,(%esp)
...
80106b23:	0f 84 fa 00 00 00    	je     80106c23 <copyuvm+0x113>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106b29:	8b 45 0c             	mov    0xc(%ebp),%eax
80106b2c:	85 c0                	test   %eax,%eax
80106b2e:	0f 84 e4 00 00 00    	je     80106c18 <copyuvm+0x108>
...
80106b75:	e8 f6 f9 ff ff       	call   80106570 <mappages>
...
80106b90:	e8 eb f7 ff ff       	call   80106380 <walkpgdir>
80106b95:	85 c0                	test   %eax,%eax
80106b97:	0f 84 8a 00 00 00    	je     80106c27 <copyuvm+0x117>
    if(!(*pte & PTE_P))
80106b9d:	8b 30                	mov    (%eax),%esi
80106b9f:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106ba5:	0f 84 88 00 00 00    	je     80106c33 <copyuvm+0x123>
    pa = PTE_ADDR(*pte);
...
80106bdf:	c3                   	ret    
  for(i = 0; i < sz; i += PGSIZE){
80106be0:	31 db                	xor    %ebx,%ebx
80106be2:	8b 75 08             	mov    0x8(%ebp),%esi
80106be5:	8b 7d 0c             	mov    0xc(%ebp),%edi
80106be8:	eb 10                	jmp    80106bfa <copyuvm+0xea>
80106bea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(i = 0; i < sz; i += PGSIZE) {
80106bf0:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106bf6:	39 df                	cmp    %ebx,%edi
80106bf8:	76 1e                	jbe    80106c18 <copyuvm+0x108>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0) {
80106bfa:	31 c9                	xor    %ecx,%ecx
80106bfc:	89 da                	mov    %ebx,%edx
80106bfe:	89 f0                	mov    %esi,%eax
80106c00:	e8 7b f7 ff ff       	call   80106380 <walkpgdir>
80106c05:	85 c0                	test   %eax,%eax
80106c07:	74 36                	je     80106c3f <copyuvm+0x12f>
    else if(!(*pte & PTE_P)) {
80106c09:	f6 00 01             	testb  $0x1,(%eax)
80106c0c:	75 e2                	jne    80106bf0 <copyuvm+0xe0>
80106c0e:	66 90                	xchg   %ax,%ax
80106c10:	eb b9                	jmp    80106bcb <copyuvm+0xbb>
...
80106c25:	eb b1                	jmp    80106bd8 <copyuvm+0xc8>
      panic("copyuvm: pte should exist");
80106c27:	c7 04 24 c0 77 10 80 	movl   $0x801077c0,(%esp)
80106c2e:	e8 2d 97 ff ff       	call   80100360 <panic>
      panic("copyuvm: page not present");
80106c33:	c7 04 24 da 77 10 80 	movl   $0x801077da,(%esp)
80106c3a:	e8 21 97 ff ff       	call   80100360 <panic>
      panic("Panic");
80106c3f:	c7 04 24 f4 77 10 80 	movl   $0x801077f4,(%esp)
80106c46:	e8 15 97 ff ff       	call   80100360 <panic>
80106c4b:	90                   	nop
...
80106c5e:	e8 1d f7 ff ff       	call   80106380 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106d26:	c7 44 24 04 20 78 10 	movl   $0x80107820,0x4(%esp)
80106d2d:	80 
80106d2e:	c7 04 24 e0 55 11 80 	movl   $0x801155e0,(%esp)
80106d35:	e8 06 d3 ff ff       	call   80104040 <initlock>
  acquire(&(shm_table.lock));
80106d3a:	c7 04 24 e0 55 11 80 	movl   $0x801155e0,(%esp)
80106d41:	e8 ea d3 ff ff       	call   80104130 <acquire>
80106d46:	b8 14 56 11 80       	mov    $0x80115614,%eax
80106d4b:	90                   	nop
...
80106d60:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for (i = 0; i< 64; i++) {
80106d67:	3d 14 59 11 80       	cmp    $0x80115914,%eax
